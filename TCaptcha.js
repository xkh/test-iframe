! function(t) {
	...
	t.exports = function f() {
		var t, e, n, r, o, a, i = arguments[0],
			...
			d = arguments.length,
			h = !1;
		for ("boolean" == typeof i && (h = i, i = arguments[1] || {}, l = 2), (null == i || "object" != typeof i &&
				"function" != typeof i) && (i = {}); l < d; ++l)
			if (null != (t = arguments[l]))
				for (e in t) n = p(i, e), i !== (r = p(t, e)) && (h && r && (s(r) || (o = c(r))) ? (o ? (o = !1, a = n && c(n) ?
					n : []) : a = n && s(n) ? n : {}, u(i, {
					name: e,
					newValue: f(h, a, r)
				})) : void 0 !== r && u(i, {
			...
			return this.map(function(e) {
				var n = function(t, e) {
					...
					if (e && "function" == typeof btoa) {
						var o = (i = r, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(
	...
	function u(t) {
		for (var e = [], n = {}, r = 0; r < t.length; r++) {
			...
			n[a] ? n[a].parts.push(i) : e.push(n[a] = {
				id: a,
				parts: [i]
			})
		}
	...
	function l(t, e) {
		...
		if (e.singleton) {
			...
			.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = document.createElement("link"),
				u = a(), s.rel = "stylesheet", u.appendChild(s), r = p(m, null, n = s), o = function() {
			...
			switch (s && "object" === (void 0 === s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(
				...
				case "object":
					...
					if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
						for (a = rep.length, n = 0; n < a; n += 1) "string" == typeof rep[n] && (o = str(r = rep[n], s)) && i.push(
							quote(r) + (gap ? ": " : ":") + o);
					else
						for (r in s) Object.prototype.hasOwnProperty.call(s, r) && (o = str(r, s)) && i.push(quote(r) + (gap ? ": " :
							":") + o);
					return o = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + c + "}" : "{" + i.join(",") +
						"}", gap = c, o
			}
	...
	i.prototype.send = a ? function(t) {
		...
		a ? "addEventListener" in document ? window.addEventListener("message", e, !1) : "attachEvent" in document &&
	...
	var grayscaleFrameJs = "https://xkh.github.io/test-iframe/tcaptcha-frame.a62693b0.js",
	...
	Captcha.prototype = {
		...
		__show__: function() {
			...
			this.destroy();
			var e = [];
			for (var n in e.push("aid=" + t.appid), e.push("accver=1"), e.push("showtype=" + t.type), e.push("ua=" +
						encodeURIComponent(btoa((navigator.userAgent || "").replace(/[\u00ff-\uffff]+/g, "")))), e.push("noheader=" +
						("" + t.showHeader == "false" ? "1" : "0")), e.push("fb=" + ("" + t.needFeedBack == "false" ? "0" : "1")), t.sid &&
					e.push("sid=" + t.sid), preVerifyData) preVerifyData[n] && e.push(n + "=" + encodeURIComponent(preVerifyData[n]));
