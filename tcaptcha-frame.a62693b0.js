! function(e) {
	...
	e.exports = function u() {
		var e, t, i, r, n, o, a = arguments[0],
			...
			l = arguments.length,
			h = !1;
		for ("boolean" == typeof a && (h = a, a = arguments[1] || {}, f = 2), (null == a || "object" != typeof a &&
				"function" != typeof a) && (a = {}); f < l; ++f)
			if (null != (e = arguments[f]))
				for (t in e) i = d(a, t), a !== (r = d(e, t)) && (h && r && (c(r) || (n = s(r))) ? (n ? (n = !1, o = i && s(i) ?
					i : []) : o = i && c(i) ? i : {}, p(a, {
					name: t,
					newValue: u(h, o, r)
				})) : void 0 !== r && p(a, {
	...
	var r, n, o = i(0),
		...
		c = (r = document.referrer, n = location.href || document.URL, r = r.length > 512 ? r.substr(0, 512) : r, n = n.length >
			1024 ? n.substr(0, 1024) : n, ["referer=" + encodeURIComponent(r), "href=" + encodeURIComponent(n)].join("&"));
	e.exports = {
		type: a,
		send: function(e, t, i) {
			try {
	...
	e.exports = {
		...
		isHorizontal: function(e, t) {
			if ("number" == typeof window.orientation && "object" === r(window.onorientationchange) && (-90 == window.orientation ||
					90 == window.orientation)) return !0;
			if (e) {
		...
		removeIfExist: function(e) {
			for (var t = window.document.getElementById(e); t;) t.parentNode.removeChild(t), t = window.document.getElementById(
				e)
		},
		...
		computeBaseFontSize: function() {
			...
			return r = (r = 0 == o || 1 == o ? r > 1.3 ? 1.3 : r : o >= .5 ? r > 2 ? 2 : r : r > 3 ? 3 : r) < .85 ? .85 : r,
				n = parseInt(1e4 * r) / 1e4 * 16, n = l ? n : 16
		},
		isMobileUa: l,
		getWindowWidth: c,
		getWindowHeight: p,
		...
		isIEVer: function(e) {
			...
			return t.innerHTML = "\x3c!--[if IE " + e + "]><i></i><![endif]--\x3e", t.getElementsByTagName("i") && 1 === t.getElementsByTagName(
				"i").length
		},
		getPos: function(e) {
			if ("undefined" != typeof e.offsetParent) {
				for (var t = 0, i = 0; e; e = e.offsetParent) {
					...
					n = n && n.indexOf("px") > -1 ? parseInt(n, 10) : 0, y && (r = n = 0), t += e.offsetLeft + r, i += e.offsetTop +
						n
				}
				return [t, i]
			}
	...
	e.exports = {
		add: function(e, t, i) {
			e && (e.addEventListener ? e.addEventListener(t, i, !1) : e.attachEvent ? e.attachEvent("on" + t, i) : e["on" +
				t] = i)
		},
		remove: function(e, t, i) {
			e && (e.removeEventListener ? e.removeEventListener(t, i, !1) : e.detachEvent ? e.detachEvent("on" + t, i) : e[
				"on" + t] = null)
		}
	}
}, function(e, t) {
			...
			return this.map(function(t) {
				var i = function(e, t) {
					...
					if (t && "function" == typeof btoa) {
						var n = (a = r, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(
	...
	function f(e, t) {
		...
		if (t.singleton) {
			...
			.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (c = document.createElement("link"),
				p = o(), c.rel = "stylesheet", p.appendChild(c), r = d(y, null, i = c), n = function() {
	...
	function() {
		...
		function str(e, t) {
			var i, r, n, o, a, s = gap,
				c = t[e];
			switch (c && "object" === (void 0 === c ? "undefined" : _typeof(c)) && "function" == typeof c.toJSON && (c = c.toJSON(
				e)), "function" == typeof rep && (c = rep.call(t, e, c)), void 0 === c ? "undefined" : _typeof(c)) {
				case "string":
					return quote(c);
				case "number":
				...
				case "object":
					...
					if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
						for (o = rep.length, i = 0; i < o; i += 1) "string" == typeof rep[i] && (n = str(r = rep[i], c)) && a.push(
							quote(r) + (gap ? ": " : ":") + n);
					else
						for (r in c) Object.prototype.hasOwnProperty.call(c, r) && (n = str(r, c)) && a.push(quote(r) + (gap ? ": " :
							":") + n);
					return n = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}" : "{" + a.join(",") +
						"}", gap = s, n
			}
		...
		"function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
			...
			if (rep = t, t && "function" != typeof t && ("object" !== (void 0 === t ? "undefined" : _typeof(t)) || "number" !=
					typeof t.length)) throw new Error("JSON.stringify");
			return str("", {
				"": e
			})
			...
			function walk(e, t) {
				...
				if (n && "object" === (void 0 === n ? "undefined" : _typeof(n)))
					for (i in n) Object.prototype.hasOwnProperty.call(n, i) && ((r = walk(n, i)) !== undefined ? n[i] = r : delete n[
						i]);
	...
	function a(e, t, i) {
		var n = "";
		if (arguments.length < 2 ? n = "[Msger] error 1" : "object" != (void 0 === e ? "undefined" : r(e)) ? n =
			"[Msger] error 2" : "string" != typeof t && (n = "[Msger] error 3"), n) throw new Error(n);
	...
	a.prototype.send = o ? function(e) {
		...
		o ? "addEventListener" in document ? window.addEventListener("message", t, !1) : "attachEvent" in document &&
			window.attachEvent("onmessage", t) : window.navigator[n + this.name] = t
		...
		n = function(e) {
			...
			return function() {
				return function(e) {
					...
					for (var t = document.getElementsByTagName("*"), i = /(^\s*)|(\s*$)/g, r = [], n = new RegExp("(^" + e +
							"\\s+|\\s+" + e + "\\s+|\\s+" + e + "$|^" + e + "$)"), o = 0; o < t.length; o++) {
	...
	"use strict";
	var r, n, o = (r = 1, (n = function(e) {
		return e = /subsid=\d+/.test(e) ? e.replace(/subsid=\d+/g, "subsid=" + r) : e.indexOf("?") >= 0 ? e + "&subsid=" +
			r : e + "?subsid=" + r, r++, e
	}).reset = function() {
		r = 1
	}, n.set = function(e) {
	...
	function d(e, t, i, c) {
		try {
			var d = n[e].size[0],
				...
				f = 0,
				l = 0;
			i ? (f = t.windowWidth, l = t.windowHeight) : (f = r.getWindowWidth(), l = r.getWindowHeight(), t.windowWidth = f,
				t.windowHeight = l);
			...
			if (h > 0 && h <= 2 * d * 16) {
				...
				d = d * b * 16 + 3, u = u * b * 16 + 3, r.isMobileUa || (d = n[e + "_pc"].width, u = n[e + "_pc"].height, p(e) ||
					"popup" != t.opts.type || (u += 40)), t.sizeSC.width = parseInt(d), t.sizeSC.height = parseInt(u);
				var w = l - u;
				...
				if (t.posSC.left = n[e].hasBorder ? Math.floor((C - 2) / 2) + "px" : Math.floor(C / 2) + "px", i) {
					...
					var x = o.border();
					x && r.setPopPosition(x, t.sizeSC.width, t.sizeSC.height, t.opts.sdkOpts), r.setPopPosition(o.tIframe(), t.sizeSC
						.width, t.sizeSC.height, t.opts.sdkOpts);
					var E = o.container();
	...
	function f(e) {
		var t, i, n, o, a = 0,
			...
			d = r.getWindowHeight(),
			u = r.getScrollTop();
		return (o = c[1] - u) >= e.sizeSC.height / 2 && d - o - p[1] / 2 >= e.sizeSC.height / 2 ? (a = c[1] + p[1] / 2 - e.sizeSC
				.height / 2, s = c[0] + 45, t = "top: 50%;", i = "top: 50%;") : o <= e.sizeSC.height / 2 ? (a = c[1] - o, s = c[0] +
				45, i = t = "top: " + (o + p[1] / 2) / e.sizeSC.height * 100 + "%;") : d - o >= p[1] && d - o - p[1] / 2 <= e.sizeSC
			.height / 2 ? (a = d - e.sizeSC.height + u, s = c[0] + 45, i = t = "top: " + (e.sizeSC.height - (d - o - p[1] / 2)) /
				e.sizeSC.height * 100 + "%;") : d - o <= p[1] ? (a = c[1] + p[1] - e.sizeSC.height, s = c[0] + 45, i = t =
				"top: " + (e.sizeSC.height - p[1] / 2) / e.sizeSC.height * 100 + "%;") : (a = c[1] + p[1] / 2 - e.sizeSC.height /
				2, s = c[0] + 45, t = "top: 50%;", i = "top: 50%;"), [a, s, t, i]
	}
	e.exports = {
		...
		createPreTrigerPoint: function(e) {
			...
			o.setAttribute("frameborder", "0", 0), o.setAttribute("border", "0"), o.marginheight = 0, o.marginwidth = 0, o.setAttribute(
				"marginheight", "0", 0), o.setAttribute("marginwidth", "0", 0), o.scrolling = "no";
			var s = r.getCSS(t.ele, "width"),
				p = r.getCSS(t.ele, "height"),
				d = 0;
			s && "auto" != s ? parseInt(s, 10) < a.CONST_PTR.minWidth ? (t.clientW = a.CONST_PTR.minWidth + "px", d = a.CONST_PTR
					.minWidth - 2 + "px") : (t.clientW = s, d = parseInt(s, 10) - 2 + "px") : (t.clientW = "100%", d = c ? "99%" :
					"100%"), !p || "auto" == p || parseInt(p, 10) < a.CONST_PTR.minHeight ? t.clientH = a.CONST_PTR.minHeight +
				"px" : t.clientH = p;
			var f = {
				width: t.clientW,
				height: t.clientH,
			...
			if (t.opts.firstvrytype && 2 == t.opts.firstvrytype && (t.clientW = a.CONST_SLIDE_PTR.width + "px", t.clientH =
					a.CONST_SLIDE_PTR.height + "px", l = {
						width: t.clientW,
						height: t.clientH,
						border: "none",
						position: "relative",
			...
			t.preTrigerPoint = o, t.wrap = i, t.wrap.appendChild(t.preTrigerPoint), t.ele.appendChild(t.wrap),
				function(e) {
		...
		fullScreen: function(e, t) {
			...
			setTimeout(function() {
				var e = r.getWindowHeight(),
					n = r.getWindowWidth();
				i.sizeSC.height = e, i.sizeSC.width = n, i.windowHeight = e, i.windowWidth = n, i.TCaptchaFrame.createSecurityCode(
	...
	_.prototype = {
		init: function(e) {
			...
			return this.wxLang = l, this.opts = n.extend({}, t, e), this.isPop = "popup" == this.opts.type, this.initOptions(),
				this.initLang(), this.listenFunc = [], this.readyFunc = function() {}, this.msg = w, this.initListener(), this.windowHeight =
				0, this.windowWidth = 0, this.sess = "", this.TCaptchaFrame = m.getInstance(this), this
		},
		initOptions: function() {
			this.ele = this.opts.ele ? this.opts.ele == document ? document.body : this.opts.ele : document.body, this.ele =
				this.opts.type && this.isPop ? document.body : this.ele, this.src = this.opts.src, this.ticket = "", this.randstr =
				"", null == this.sizeSC && (this.sizeSC = n.extend({}, c.CONST_DEFAULT_SIZE)), null == this.posSC && (this.posSC =
					n.extend({}, c.CONST_SC_PS))
		},
		initLang: function() {
			if (this.wxLang) u.init(this.wxLang);
			else {
		...
		initListener: function() {
			...
			this.msg.clear(), this.msg.listen(function(t) {
				...
				if (t && t.message && t.message.type) {
					...
					switch (i) {
						case 3:
							if (e.opts.startFn(), t && t.ticket) e.ticket = t.ticket, e.randstr = t.randstr, n.removeIfExist(
								"tcaptcha_container"), n.removeIfExist("tcaptcha_transform"), n.removeIfExist("t_mask"), n.callbackExecutor(
								e, {
									ret: 0,
									ticket: t.ticket,
									randstr: t.randstr
								...
								if (t && t.src) {
									...
									var c = t.src;
									t.src.indexOf("http:") > -1 && e.opts.domain && e.opts.domain.indexOf("https:") > -1 && (c = (c = c.replace(
										"http://captcha.qq.com", "https://ssl.captcha.qq.com")).replace("http://ssl.captcha.qq.com",
										"https://ssl.captcha.qq.com")), e.TCaptchaFrame.createSecurityCode(r, f(c))
								}
								...
								var l = {
									...
									success: function(t) {
										...
										var i = n.getCapType(t.capclass, t.subcapclass),
											r = a.tIframe();
										e.isPop && h.setCaptchaIframeSizeAndPos(i, e, !0, !0), a.border() && s[i].unionSizeType ? e.TCaptchaFrame
											.showRefreshDom() : r.src = e.src
									},
									error: function() {}
								};
								e.getPrehandle(l)
		...
		create: function() {
			switch (this.opts.type) {
				...
				case "popup":
				default:
					b || (h.addPopupStyle(this), b = !0), this.opts.tcaptchaFlag && this.isPop && this.TCaptchaFrame.createSmartVerify(),
		...
		prehandleSuccess: function(e) {
			...
			try {
				...
				var i = n.getCapType(e.capclass, e.subcapclass),
					r = (new Date).getTime();
				if (t.prehandleLoadTime = r - t.loadStart, t.createIframeStart = r, "embed" == t.opts.type) return h.setCaptchaIframeSizeAndPos(
					i, t, !1, !0), t.src = n.addUrlParam(t.src, {
					noBorder: "noborder",
					fb: t.opts.fb,
					forcestyle: t.opts.forcestyle
				...
				t.isPop ? (window.onresize = function() {
					...
					h.setCaptchaIframeSizeAndPos(i, t, !1, !0), t.opts.tcaptchaFlag && t.TCaptchaFrame.enlargeVerifyType(a.tVerify(),
						t.sizeSC.width, t.sizeSC.height, t.opts.sdkOpts), t.TCaptchaFrame.createSecurityCode(i), h.popupResize(t,
						i)
		...
		destroy: function() {
			n.removeIfExist("t_mask"), n.removeIfExist("tcaptcha_transform"), n.removeIfExist("tcaptcha_container"), n.removeIfExist(
				"t_verify"), S && (this.closeSecurityCode(), this.listenFunc = [], this.listenFunc.length = 0, this.readyFunc =
				function() {}, S = null)
		},
		refresh: function(e) {
			n.removeIfExist("tcaptcha_container"), n.removeIfExist("t_verify"), S && (this.closeSecurityCode(), this.clearContainer(),
				this.initOptions(), e && n.isObject(e) && ("undefined" != typeof e.uin && (this.opts.uid = e.uin), "undefined" !=
					typeof e.uid && (this.opts.uid = e.uid), "undefined" != typeof e.capcd && (this.opts.capcd = e.capcd)), this.create()
			)
		},
		...
		closeSecurityCode: function(e) {
			...
			this.securityIframe && (this.securityIframe.parentNode && this.securityIframe.parentNode.removeChild(this.securityIframe),
				this.securityIframe = null), n.isFunction(e) && e(), window.CollectGarbage && window.CollectGarbage()
		},
		getTicket: function() {
			return {
				ticket: this.ticket,
	...
	var r = ["c2", "c3", "c11", "c12", "c21", "c22", "c23"],
		n = {
			"zh-cn": ["\u5b89\u5168\u9a8c\u8bc1", "\u9a8c\u8bc1\u6210\u529f", "\u8fd4\u56de", "\u9a8c\u8bc1\u4e2d...",
				"\u9a8c\u8bc1\u6210\u529f", "\u5c1d\u8bd5\u592a\u591a\u4e86",
				"2s\u540e\u81ea\u52a8\u4e3a\u60a8\u5237\u65b0\u9a8c\u8bc1\u7801"
			],
			"zh-hk": ["\u5b89\u5168\u9a57\u8b49", "\u9a57\u8b49\u6210\u529f", "\u8fd4\u56de", "\u9a57\u8b49\u4e2d\u22ef",
				"\u9a57\u8b49\u6210\u529f", "\u932f\u8aa4\u6b21\u6578\u592a\u591a",
				"\u9a57\u8b49\u78bc\u5c07\u65bc 2 \u79d2\u5f8c\u81ea\u52d5\u66f4\u65b0"
			],
			"zh-tw": ["\u5b89\u5168\u9a57\u8b49", "\u9a57\u8b49\u6210\u529f", "\u8fd4\u56de", "\u9a57\u8b49\u4e2d...",
				"\u9a57\u8b49\u6210\u529f", "\u5617\u8a66\u6b21\u6578\u592a\u591a",
				"2\u79d2\u5f8c\u81ea\u52d5\u70ba\u60a8\u91cd\u65b0\u6574\u7406\u9a57\u8b49\u78bc"
			],
			en: ["Security Verification", "Verification is successful", "Back", "Verifying...", "Verification is successful",
				"Refreshing too often", "Verification Code will refresh in 2 sec."
			],
			ar: ["\u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u0627\u0644\u062d\u0645\u0627\u064a\u0629",
				"\u0646\u062c\u0627\u062d \u0627\u0644\u062a\u062d\u0642\u0642", "\u0639\u0648\u062f\u0629",
				"\u062c\u0627\u0631\u064a \u0627\u0644\u062a\u062d\u0642\u0642...",
				"\u0646\u062c\u0627\u062d \u0627\u0644\u062a\u062d\u0642\u0642",
				"\u0643\u062b\u0631\u0629 \u0627\u0644\u062a\u062d\u062f\u064a\u062b",
				"\u0633\u064a\u062a\u0645 \u062a\u062d\u062f\u064a\u062b \u0643\u0648\u062f \u0627\u0644\u062a\u062d\u0642\u0642 \u062e\u0644\u0627\u0644 2 \u062b\u0627\u0646\u064a\u0629."
			],
			my: [
				"\u101c\u1036\u102f\u107f\u1001\u1036\u1033\u1031\u101b\u1038\u1021\u1010\u100a\u1039\u103b\u1015\u1033\u103b\u1001\u1004\u1039\u1038",
				"\u1021\u1010\u100a\u1039\u103b\u1015\u1033\u1019\u1088 \u1031\u1021\u102c\u1004\u1039\u103b\u1019\u1004\u1039\u1015\u102b\u101e\u100a\u1039",
				"\u1031\u1014\u102c\u1000\u1039\u101e\u102d\u102f\u1094",
				"\u1021\u1010\u100a\u1039\u103b\u1015\u1033\u1031\u1014\u101e\u100a\u1039...",
				"\u1021\u1010\u100a\u1039\u103b\u1015\u1033\u1019\u1088 \u1031\u1021\u102c\u1004\u1039\u103b\u1019\u1004\u1039\u1015\u102b\u101e\u100a\u1039",
				"\u1019\u107e\u1000\u102c\u1001\u1014\u103b\u1015\u1014\u1039\u1016\u103c\u1004\u1039\u1037\u1031\u1014\u101b\u101e\u100a\u1039\u104b",
				"2 \u1005\u1000\u1060\u1014\u1039\u1094\u1021\u1010\u103c\u1004\u1039\u1038 \u1021\u1010\u100a\u1039\u103b\u1015\u1033\u101b\u1014\u1039Code \u1021\u101e\u1005\u1039\u1031\u1015\u105a\u1015\u102b\u1019\u100a\u1039"
			],
			fr: ["V\xe9rification de s\xe9curit\xe9", "La v\xe9rification est r\xe9ussie", "Retour", "V\xe9rification...",
				"La v\xe9rification est r\xe9ussie", "Trop actualis\xe9", "Le code de v\xe9rification s'actualisera dans 2 sec."
			],
			de: ["Sicherheitsbest\xe4tigung", "Verifizierung erfolgreich", "Zur\xfcck", "Wird verifziert\xa0\u2026",
				"Verifizierung erfolgreich", "Zu oft aktualisiert", "Verifizierungscode wird in 2 Sekunden aktualisiert."
			],
			he: ["\u05d0\u05d9\u05de\u05d5\u05ea \u05d0\u05d1\u05d8\u05d7\u05d4",
				"\u05d4\u05d0\u05d9\u05de\u05d5\u05ea \u05e2\u05d1\u05e8 \u05d1\u05d4\u05e6\u05dc\u05d7\u05d4",
				"\u05d7\u05d6\u05e8\u05d4", "\u05de\u05d0\u05de\u05ea",
				"\u05d4\u05d0\u05d9\u05de\u05d5\u05ea \u05e2\u05d1\u05e8 \u05d1\u05d4\u05e6\u05dc\u05d7\u05d4",
				"\u05de\u05e8\u05e2\u05e0\u05df \u05dc\u05e2\u05ea\u05d9\u05dd \u05e7\u05e8\u05d5\u05d1\u05d5\u05ea \u05de\u05d9\u05d3\u05d9",
				"\u05e7\u05d5\u05d3 \u05d4\u05d0\u05d9\u05de\u05d5\u05ea \u05d9\u05ea\u05d7\u05d3\u05e9 \u05d1\u05ea\u05d5\u05da 2 \u05e9\u05e0\u05d9\u05d5\u05ea"
			],
			hi: ["\u0938\u0941\u0930\u0915\u094d\u0937\u093e \u0938\u0924\u094d\u092f\u093e\u092a\u0928",
				"\u0938\u0924\u094d\u092f\u093e\u092a\u0928 \u0938\u092b\u0932", "\u092a\u0940\u091b\u0947",
				"\u0938\u0924\u094d\u092f\u093e\u092a\u0928 \u091c\u093e\u0930\u0940...",
				"\u0938\u0924\u094d\u092f\u093e\u092a\u0928 \u0938\u092b\u0932",
				"\u0905\u0915\u094d\u0938\u0930 \u0930\u0940\u092b\u094d\u0930\u0947\u0936 \u0939\u094b \u0930\u0939\u093e \u0939\u0948\u0964",
				"\u0938\u0924\u094d\u092f\u093e\u092a\u0928 \u0915\u094b\u0921 2 \u0938\u0947\u0915. \u092e\u0947\u0902 \u0930\u0940\u092b\u094d\u0930\u0947\u0936 \u0939\u094b\u0917\u093e"
			],
			id: ["Verifikasi Keamanan", "Verifikasi berhasil", "Kembali", "Memverifikasi...", "Verifikasi berhasil",
				"Terlalu sering merefresh.", "Kode Verifikasi akan di-refresh dalam 2 detik."
			],
			it: ["Verifica di sicurezza", "Verifica completata", "Indietro", "Verifica in corso", "Verifica completata",
				"Troppo frequente", "Il codice di verifica sar\xe0 aggiornato tra 2 secondi"
			],
			ja: ["\u30bb\u30ad\u30e5\u30ea\u30c6\u30a3\u8a8d\u8a3c", "\u8a8d\u8a3c\u304c\u6b63\u5e38\u306b\u5b8c\u4e86",
				"\u623b\u308b", "\u8a8d\u8a3c\u4e2d\u2026", "\u8a8d\u8a3c\u304c\u6b63\u5e38\u306b\u5b8c\u4e86",
				"\u66f4\u65b0\u983b\u5ea6\u304c\u9ad8\u3059\u304e\u307e\u3059",
			...
			ko: ["\ubcf4\uc548 \uc778\uc99d", "\uc778\uc99d \uc131\uacf5", "\ub4a4\ub85c\uac00\uae30",
				"\uc778\uc99d \uc911...", "\uc778\uc99d \uc131\uacf5",
				"\uc0c8\ub85c\uace0\uce68\uc774 \ub108\ubb34 \uc7a6\uc2b5\ub2c8\ub2e4",
				"\uc778\uc99d \ucf54\ub4dc\uac00 2\ucd08 \ud6c4\uc5d0 \uc0c8\ub85c\uace0\uce68 \ub429\ub2c8\ub2e4."
			],
			lo: [
				"\u0e81\u0eb2\u0e99\u0ea2\u0eb7\u0e99\u0ea2\u0eb1\u0e99\u0e84\u0ea7\u0eb2\u0ea1\u0e9b\u0ead\u0e94\u0ec4\u0e9e",
				"\u0e81\u0eb2\u0e99\u0ea2\u0eb7\u0e99\u0ea2\u0eb1\u0e99\u0ec4\u0e94\u0ec9\u0eaa\u0eb3\u0ec0\u0ea5\u0eb1\u0e94\u0ec1\u0ea5\u0ec9\u0ea7",
				"\u0e81\u0eb1\u0e9a\u0e84\u0eb7\u0e99", "\u0e81\u0eb3\u0ea5\u0eb1\u0e87\u0ea2\u0eb7\u0e99\u0ea2\u0eb1\u0e99...",
				"\u0e81\u0eb2\u0e99\u0ea2\u0eb7\u0e99\u0ea2\u0eb1\u0e99\u0ec4\u0e94\u0ec9\u0eaa\u0eb3\u0ec0\u0ea5\u0eb1\u0e94\u0ec1\u0ea5\u0ec9\u0ea7",
				"\u0e9f\u0eb7\u0ec9\u0e99\u0e9f\u0eb9\u0e84\u0eb7\u0e99\u0ec0\u0ea5\u0eb7\u0ec9\u0ead\u0e8d\u0ec6",
				"\u0ea5\u0eb0\u0eab\u0eb1\u0e94\u0ea2\u0eb7\u0e99\u0ea2\u0eb1\u0e99\u0e88\u0eb0\u0ea1\u0eb5\u0e81\u0eb2\u0e99\u0e9f\u0eb7\u0ec9\u0e99\u0e9f\u0eb9\u0e84\u0eb7\u0e99\u0ec3\u0eab\u0ea1\u0ec8\u0e9e\u0eb2\u0e8d\u0ec3\u0e99 2 \u0ea7\u0eb4\u0e99\u0eb2\u0e97\u0eb5"
			],
			ms: ["Pengesahan Keselamatan", "Pengesahan berjaya", "Kembali", "Mengesahkan...", "Pengesahan berjaya",
				"Terlalu kerap segar semula", "Kod Pengesahan akan disegar semula dalam 2 saat"
			],
			pl: ["Weryfikacja bezpiecze\u0144stwa", "Weryfikacja powiod\u0142a si\u0119", "Wstecz", "Weryfikowanie...",
				"Weryfikacja powiod\u0142a si\u0119", "Za cz\u0119sto od\u015bwie\u017casz",
				"Kod weryfikacyjny zostanie od\u015bwie\u017cony za 2 s."
			],
			pt: ["Verifica\xe7\xe3o de Seguran\xe7a", "Verificado com sucesso", "Voltar", "Verificando...",
				"Verificado com sucesso", "Atualizando muito", "C\xf3digo de Verifica\xe7\xe3o ser\xe1 atualizado em 2 seg."
			],
			ru: [
				...
				"\u041f\u0440\u043e\u0432\u0435\u0440\u043e\u0447\u043d\u044b\u0439 \u043a\u043e\u0434 \u0431\u0443\u0434\u0435\u0442 \u043e\u0431\u043d\u043e\u0432\u043b\u0435\u043d \u0447\u0435\u0440\u0435\u0437 2 \u0441\u0435\u043a."
			],
			es: ["Verificaci\xf3n de seguridad", "Verificaci\xf3n correcta", "Atr\xe1s", "Verificando...",
				"Verificaci\xf3n correcta", "Actualizaci\xf3n muy frecuente", "El c\xf3digo se actualizar\xe1 en 2 segundos."
			],
			th: [
				...
				"\u0e01\u0e32\u0e23\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e2a\u0e33\u0e40\u0e23\u0e47\u0e08\u0e41\u0e25\u0e49\u0e27",
				"\u0e23\u0e35\u0e40\u0e1f\u0e23\u0e0a\u0e1a\u0e48\u0e2d\u0e22\u0e40\u0e01\u0e34\u0e19\u0e44\u0e1b",
				"\u0e23\u0e2b\u0e31\u0e2a\u0e01\u0e32\u0e23\u0e22\u0e37\u0e19\u0e22\u0e31\u0e19\u0e08\u0e30\u0e23\u0e35\u0e40\u0e1f\u0e23\u0e0a\u0e20\u0e32\u0e22\u0e43\u0e19 2 \u0e27\u0e34\u0e19\u0e32\u0e17\u0e35"
			],
			tr: ["G\xfcvenlik Do\u011frulamas\u0131", "Do\u011frulama ba\u015far\u0131l\u0131", "Geri",
				"Do\u011frulan\u0131yor", "Do\u011frulama ba\u015far\u0131l\u0131", "Yenilemeler \xe7ok s\u0131k",
				"Do\u011frulama Kodu 2 sn. sonra yenilenecek."
			],
			vi: ["X\xe1c minh b\u1ea3o m\u1eadt", "X\xe1c minh th\xe0nh c\xf4ng", "Quay l\u1ea1i", "\u0110ang x\xe1c minh...",
				"X\xe1c minh th\xe0nh c\xf4ng", "L\xe0m m\u1edbi qu\xe1 th\u01b0\u1eddng xuy\xean",
				"M\xe3 x\xe1c minh s\u1ebd \u0111\u01b0\u1ee3c l\xe0m m\u1edbi sau 2 gi\xe2y."
			]
		};
	...
	var r = i(4),
		...
		l = function() {
			function e(e) {
				e = e || {};
				this.name = "TCaptchaFrameProxy", this.initSecurityCodeTarget = function() {
					...
					i.id = "t_verify", i.className = "t-verify";
					var n = r.createElement("div");
					n.className = "verify-icon", n.id = "verify_icon", i.appendChild(n);
					...
					r.CSS(a, p), r.CSS(s, p), r.CSS(c, p), n.appendChild(a), n.appendChild(s), n.appendChild(c);
					var d = r.createElement("p");
					d.className = "verify-text", d.id = "verify_text", i.appendChild(d);
					var u = r.getPosStyle(e.opts),
						f = r.computeBaseFontSize();
					e.opts.sdkOpts && e.opts.sdkOpts.width && e.opts.sdkOpts.height && (f *= e.opts.sdkOpts.width / (o.SMART_VERIFY_SZ
						.width * f));
					var l = {
						border: e.opts.sdkOpts && e.opts.sdkOpts.width ? "0" : "1px solid #e5e5e5",
						position: u
					};
					r.CSS(i, l), e.ele.appendChild(i), r.setPopPosition(i, o.SMART_VERIFY_SZ.width * f, o.SMART_VERIFY_SZ.height *
						f, e.opts.sdkOpts)
				}, this.createFlimitDom = function() {
					var t = r.getPosStyle(e.opts),
						i = "";
					e.opts.params.split("lang=")[1] && e.opts.params.split("lang=")[1].split("&")[0] && !e.opts.tcaptchaFlag && (i =
						e.opts.params.split("lang=")[1].split("&")[0], e.langPack.init(i));
					var n = r.createElement("div");
					n.className = "tcaptcha-transform" + (r.isChrome75 && r.isMobileUa ? " chrome-75" : ""), n.id =
						"tcaptcha_transform";
					var o = {
						position: t,
					...
					s.className = "ticons ticon-refresh", s.id = "ticon_refresh";
					var c = r.createElement("p");
					c.className = "ticons transform-header", c.id = "transform_header", c.innerText = e.langPack.c22;
					var p = r.createElement("p");
					if (p.className = "ticons transform-text", p.id = "transform_text", p.innerText = e.langPack.c23, n.appendChild(
							s), n.appendChild(c), n.appendChild(p), e.isPop) {
						var d = r.createElement("div");
						d.id = "transform_close", d.className = "ticons transform-close", n.appendChild(d), a.add(d, "click", function() {
						...
						f.className = "ticons tback transform-eicon", f.id = "transform_eicon";
						var l = r.createElement("div");
						l.className = "ticons tback transform-eb", l.id = "transform_eb", l.innerText = e.langPack.c11;
						var h = r.createElement("p");
						h.className = "ticons transform-eh", h.id = "transform_eh", e.langPack.c2.length > 20 ? (r.addClass(h,
							"middle-fontsize"), r.addClass(l, "middle-fontsize")) : e.langPack.c2.length > 15 && (r.addClass(h,
							"small-fontsize"), r.addClass(l, "small-fontsize")), h.innerText = e.langPack.c2, n.appendChild(f), n.appendChild(
							l), n.appendChild(h), a.add(l, "click", function() {
					...
					try {
						...
						if (s) {
							f || (i(62), f = !0);
							var u = (b = "div", document.createElement(b));
							u.className = "tcaptcha-container", u.id = "tcaptcha_container", e._div = u;
							var l = {
								width: e.sizeSC.width + "px",
								height: e.sizeSC.height + "px"
							};
							r.CSS(u, l), (v = document.createElement("iframe")).className = "tcaptcha-container-iframe", v.id =
								"tcaptcha_iframe", v.setAttribute("frameborder", "0", 0), v.setAttribute("border", "0"), v.marginheight = 0,
								v.marginwidth = 0, v.setAttribute("marginheight", "0", 0), v.setAttribute("marginwidth", "0", 0), v.scrolling =
								"no", e.securityIframe = v, u.appendChild(v), document.body.appendChild(u), e.src = r.addUrlParam(e.src, a),
								v.src = o || e.src, this.setDivPosition(u), this.initSecurityCodeTarget()
							...
							if (this.hasSecurityCode()) {
								...
								return r.CSS(e.securityIframe, h), void(e.securityIframe.src = r.addUrlParam(e.src, a))
							}
							var m = r.createElement("iframe");
							m.id = "tcaptcha_iframe", m.className = "tcaptcha-iframe", m.setAttribute("frameborder", "0", 0), m.setAttribute(
								"border", "0"), m.setAttribute("marginheight", "0", 0), m.setAttribute("marginwidth", "0", 0), e.isPop ? (m
								.setAttribute("scrolling", "no"), c[t].isOpt, r.CSS(m, {
									opacity: "1"
								})) : r.CSS(m, {
								border: "0px"
							});
							...
							if (c[t].unionSizeType ? g.position = "static" : (g.top = e.posSC.top, g.left = e.posSC.left), r.CSS(m, g), e
								.securityIframe = m, c[t].unionSizeType) {
								var y = e.TCaptchaFrame.createFlimitDom();
								y.appendChild(m), e.ele.appendChild(y)
							} else e.ele.appendChild(m);
							e.src = r.addUrlParam(e.src, a), m.src = e.src, this.initSecurityCodeTarget()
						} else {
							var v;
							(v = document.createElement("iframe")).setAttribute("frameborder", "0", 0), v.setAttribute("border", "0"), v.marginheight =
								0, v.marginwidth = 0, v.setAttribute("marginheight", "0", 0), v.setAttribute("marginwidth", "0", 0), v.scrolling =
								"no", v.id = "tcaptcha_iframe";
							l = {
								width: "300px",
								height: "230px",
								border: "0px",
							...
							"embed" != e.opts.type || "slidepuzzle_new" !== t && "slidepuzzle_opt" !== t ? (l.width = e.sizeSC.width +
									"px", l.height = e.sizeSC.height + "px") : (l.width = "300px", l.height = "230px"), r.CSS(v, l), e.securityIframe =
								v, e.ele.appendChild(v), e.src = r.addUrlParam(e.src, a), v.src = e.src, n.setPosition(e, v), this.initSecurityCodeTarget()
						}
						e.opts.capType = t
					} catch (w) {
					...
					try {
						...
						if ("point" == e.opts.type) {
							...
							d.rel = "stylesheet", d.href = "style.css", d.type = "text/css", document.getElementsByTagName("body")[0].appendChild(
								d), setTimeout(function() {
								h(document.styleSheets[document.styleSheets.length - 1], ".tcaptcha-container:before", s, 0), h(document.styleSheets[
									document.styleSheets.length - 1], ".tcaptcha-container:after", c, 0)
							}, 1)
						}
						return r.CSS(t, {
							top: i + "px",
					...
					var t = s.dots();
					if (t)
						for (var i = 0; i < t.length; i++) r.addClass(t[i], "show-none");
					var n = s.verifyIcon();
					...
					for (var t = s.tIframe(), i = s.ref2Text(), n = s.tIcons(), o = n.length, a = 0; a < o; a++) n[a] && r.addClass(
						n[a], "show-icon");
	...
	(e.exports = i(6)(!1)).push([e.i,
		'.tcaptcha-container{border:1px solid #e5e5e5;position:absolute;left:0;top:0;z-index:2000000002}.tcaptcha-container:after,.tcaptcha-container:before{content:"";height:0;width:0;position:absolute;left:-17px;top:50%;margin-top:-9.5px;border-left:9px solid transparent;border-top:9px solid transparent;border-bottom:9px solid transparent;border-right:9px solid rgba(63,63,63,.1);z-index:0}.tcaptcha-container:after{border-right:9px solid #fff;z-index:1}.tcaptcha-container-iframe{display:block;width:100%;height:100%;border:0;background:#fff;visibility:visible}',
		""
	])
}]);
